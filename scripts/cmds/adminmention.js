...
module.exports = {
  ...
  onChat: async function ({ event, message }) {
    ...
    const admins = [
      { uid: "61589439339903", names: ["M'ʀ Fʌʀʜʌŋ"] },
      { uid: "61589439339903", names: ["MUNNA VAI MBS"] }
    ];
    ...
    const captions = [
      ...
      "👉আমার বস ♻️ ফাহিম এখন বিজি আছে । তার ইনবক্সে এ মেসেজ দিয়ে রাখো https://m.me/fahim.ahmed.raj.207🔰 ♪√বস ফ্রি হলে আসবে🧡😁😜🐒",
